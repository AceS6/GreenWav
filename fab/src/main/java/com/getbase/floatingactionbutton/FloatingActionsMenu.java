 ...
 * Xml attribute to set a custom image to the FloatingActionMenu
 */
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mIcon = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_menu_icon, 0);
        attr.recycle();
        ...
        mAddButton = new AddFloatingActionButton(context) {
            ...
            Drawable getIconDrawable() {
                ...
                if (mIcon == 0) {
                    ...
                    rotatingDrawable = new RotatingDrawable(this.getResources().getDrawable(mIcon));
                }
