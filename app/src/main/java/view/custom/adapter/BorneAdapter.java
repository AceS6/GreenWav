 ...
 * @version 1.0
 */
public class BorneAdapter extends RecyclerView.Adapter<BorneAdapter.ViewHolder> {
    ...
    public BorneAdapter(Activity activity) {
    ...
    @Override
    public BorneAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
